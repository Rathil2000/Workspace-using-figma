...
const SheetsThreePage = () => {
  ...
  function handleBackNavigation13() {
    navigate(-1);
  }
          ...
          <Row className="items-center w-[100%]">
            <Stack className="bg-white_A700 border border-gray_301 border-solid lg:h-[39px] xl:h-[45px] 2xl:h-[51px] 3xl:h-[61px] lg:px-[11px] xl:px-[13px] 2xl:px-[15px] 3xl:px-[18px] rounded-radius11 w-[3%]">
              <Img
                ...
                onClick={handleBackNavigation13}
                alt="arrowleft"
              />
            </Stack>
          ...
          <Row className="items-center justify-evenly w-[100%]">
            <Stack className="lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[81%]">
              <Stack className="absolute lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[100%]">
                <Row className="absolute items-center justify-evenly w-[100%]">
                  ...
                  <Row
                    className="common-pointer bg-white_A700 border border-gray_301 border-solid items-center justify-between 3xl:p-[10px] lg:p-[7px] xl:p-[8px] 2xl:p-[9px] w-[77%]"
                  ...
                  >
                    ...
                    <Column className="items-center lg:mr-[6px] xl:mr-[7px] 2xl:mr-[8px] 3xl:mr-[9px] w-[47%]">
                      ...
                      <Column className="bg-gray_50 border border-light_blue_500 border-solid items-center mt-[3px] lg:p-[38px] xl:p-[44px] 2xl:p-[50px] 3xl:p-[60px] rounded-radius11 w-[100%]">
            ...
            <Column className="bg-white_A700 border border-gray_301 border-solid items-center xl:pb-[1115px] 2xl:pb-[1254px] 3xl:pb-[1505px] lg:pb-[975px] w-[19%]">
              <Column className="bg-white_A700 items-center w-[100%]">
                ...
                <Text className="bg-white_A700 border border-gray_301 border-solid font-bold lg:pl-[14px] xl:pl-[16px] 2xl:pl-[18px] 3xl:pl-[21px] lg:py-[19px] xl:py-[22px] 2xl:py-[25px] 3xl:py-[30px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 w-[262px]">
                  2. Select product expiry date
                </Text>
...
export default SheetsThreePage;
