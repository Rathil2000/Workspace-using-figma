        ...
        <Row className="justify-evenly w-[97%]">
          ...
          <Column className="lg:mt-[13px] xl:mt-[15px] 2xl:mt-[17px] 3xl:mt-[20px] w-[90%]">
            ...
            <Row className="lg:mt-[24px] xl:mt-[28px] 2xl:mt-[32px] 3xl:mt-[38px] w-[100%]">
              <SelectBox
                className="font-normal lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 underline w-[21%]"
                placeholderClassName="text-black_900"
                name="Group427319571"
                placeholder="Light Duty Line"
                isSearchable={false}
                isMulti={false}
                indicator={
                  <Img
              ...
              ></SelectBox>
              <SelectBox
                className="font-normal 3xl:ml-[10px] lg:ml-[7px] xl:ml-[8px] 2xl:ml-[9px] lg:mt-[4px] xl:mt-[5px] 2xl:mt-[6px] 3xl:mt-[7px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 underline w-[21%]"
                placeholderClassName="text-black_900"
                name="Group427319571 One"
                placeholder="Press Up Station"
                isSearchable={false}
                isMulti={false}
                indicator={
                  <Img
            ...
            <Row className="items-center lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] w-[100%]">
              <Column
                className="bg-cover bg-repeat lg:p-[17px] xl:p-[19px] 2xl:p-[22px] 3xl:p-[26px] w-[15%]"
                style={{
                  backgroundImage: "url('images/img_group427318743.svg')",
                }}
              >
                <Text className="font-bold mb-[2px] lg:ml-[24px] xl:ml-[28px] 2xl:ml-[32px] 3xl:ml-[38px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 w-[auto]">
                  Sheet ID
                </Text>
              </Column>
              <Column className="bg-white_A700 border border-gray_301 border-solid lg:p-[17px] xl:p-[19px] 2xl:p-[22px] 3xl:p-[26px] w-[32%]">
                <Text className="font-bold mb-[2px] lg:ml-[101px] xl:ml-[116px] 2xl:ml-[131px] 3xl:ml-[157px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 w-[auto]">
                  Sheet Name
                </Text>
              </Column>
              <Button
                className="font-bold lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-center w-[15%]"
                size="2xl"
              >
                Linked Asset
              </Button>
              <Button
                className="font-bold lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-center w-[19%]"
                size="2xl"
              >
                Sub-Asset
              </Button>
              <Column className="bg-white_A700 border border-gray_301 border-solid items-center lg:p-[16px] xl:p-[18px] 2xl:p-[21px] 3xl:p-[25px] w-[9%]">
                <Text className="font-bold mt-[4px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 w-[auto]">
                  Steps
                </Text>
              </Column>
              <Column
                className="bg-cover bg-repeat items-center lg:p-[17px] xl:p-[20px] 2xl:p-[23px] 3xl:p-[27px] w-[9%]"
                style={{
                  backgroundImage: "url('images/img_group427318748.svg')",
                }}
              >
                <Text className="font-bold mt-[1px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 w-[auto]">
                  Version
                </Text>
              </Column>
            </Row>
            <Row className="items-center w-[100%]">
              <Column
                className="bg-cover bg-repeat lg:p-[17px] xl:p-[20px] 2xl:p-[23px] 3xl:p-[27px] w-[15%]"
                style={{ backgroundImage: "url('images/img_group53.svg')" }}
              >
                <Text className="font-normal mb-[1px] lg:ml-[31px] xl:ml-[36px] 2xl:ml-[41px] 3xl:ml-[49px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 w-[auto]">
                  CTQ01
                </Text>
              </Column>
              <Button
                className="font-normal not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-center w-[32%]"
                size="xl"
              >
                First Piece CTQ: Tube Press Up
              </Button>
              <Button
                className="font-normal not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-center underline w-[15%]"
                size="xl"
              >
                Light Duty Line
              </Button>
              <Button
                className="font-normal not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-center underline w-[19%]"
                size="xl"
              >
                Tube Press Up Station
              </Button>
              <Button
                className="font-normal not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-center w-[9%]"
                size="xl"
              >
                02
              </Button>
              <Column
                className="bg-cover bg-repeat lg:p-[17px] xl:p-[20px] 2xl:p-[23px] 3xl:p-[27px] w-[10%]"
                style={{ backgroundImage: "url('images/img_group54.svg')" }}
              >
                <Text className="font-normal lg:ml-[22px] xl:ml-[25px] 2xl:ml-[29px] 3xl:ml-[34px] mt-[1px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 w-[auto]">
                  01
                </Text>
              </Column>
            </Row>
...
export default SheetsLibraryOnePage;
