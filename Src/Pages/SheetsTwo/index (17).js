...
import { Column, Stack, Img, Row, Text, Button, Input, Line } from "components";

const SheetsTwoPage = () => {
  const navigate = useNavigate();

  function handleNavigate24() {
    navigate("/sheetsseven");
  }
  function handleNavigate25() {
    navigate("/sheetseleven");
  }
  function handleBackNavigation12() {
    navigate(-1);
  }
          ...
          <Row className="items-center w-[100%]">
            <Stack className="bg-white_A700 border border-gray_301 border-solid lg:h-[39px] xl:h-[45px] 2xl:h-[51px] 3xl:h-[61px] lg:px-[11px] xl:px-[13px] 2xl:px-[15px] 3xl:px-[18px] rounded-radius11 w-[3%]">
              <Img
                ...
                onClick={handleBackNavigation12}
                alt="arrowleft"
              />
            </Stack>
            ...
            <Stack className="lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[81%]">
              <Stack className="absolute lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[100%]">
                <Row className="absolute items-center justify-evenly w-[100%]">
                  ...
                  <Stack className="bg-white_A700 border border-gray_301 border-solid lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] lg:px-[14px] xl:px-[16px] 2xl:px-[18px] 3xl:px-[21px] w-[77%]">
                    <Column className="absolute items-center left-[0] top-[6%] w-[46%]">
                      <Row className="items-center justify-between w-[95%]">
                        ...
                        <Img
                          ...
                          className="xl:h-[3px] lg:h-[3px] 3xl:h-[4px] 2xl:h-[4px] w-[5%]"
                          alt="Vector"
                        />
                      </Row>
                      <Column className="bg-gray_50 border border-gray_301 border-solid mt-[3px] 2xl:p-[11px] 3xl:p-[13px] lg:p-[8px] xl:p-[9px] rounded-radius11 w-[100%]">
                        <Row className="items-center mt-[1px] w-[98%]">
                          <Column className="bg-white_A700 border border-gray_301 border-solid lg:h-[14px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] items-center px-[3px] rounded-radius50 lg:w-[14px] xl:w-[16px] 2xl:w-[18px] 3xl:w-[21px]">
                            <div
                              className="common-pointer bg-light_blue_500 border border-gray_301 border-solid lg:h-[10px] xl:h-[11px] 2xl:h-[13px] 3xl:h-[15px] rounded-radius50 xl:w-[10px] 2xl:w-[12px] 3xl:w-[14px] lg:w-[9px]"
                        ...
                        <Row className="items-center lg:mt-[6px] xl:mt-[7px] 2xl:mt-[8px] 3xl:mt-[9px] w-[98%]">
                          <div
                            className="common-pointer bg-white_A700 border border-gray_301 border-solid lg:h-[14px] xl:h-[17px] 2xl:h-[19px] 3xl:h-[22px] rounded-radius50 lg:w-[14px] xl:w-[16px] 2xl:w-[18px] 3xl:w-[21px]"
                    ...
                    <Stack className="absolute bg-gray_300 lg:h-[18px] xl:h-[21px] 2xl:h-[24px] 3xl:h-[28px] left-[45%] px-[1px] top-[11%] w-[1%]">
                      <Img
