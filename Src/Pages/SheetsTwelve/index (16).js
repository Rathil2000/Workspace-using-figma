            ...
            <Stack className="lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[81%]">
              <Stack className="absolute lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[100%]">
                <Row className="absolute items-center justify-evenly w-[100%]">
                  ...
                  <Row className="bg-white_A700 border border-gray_301 border-solid justify-between lg:p-[6px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] w-[77%]">
                    <Stack className="bg-white_A700 lg:h-[126px] xl:h-[144px] 2xl:h-[162px] 3xl:h-[194px] xl:mb-[1009px] 2xl:mb-[1135px] 3xl:mb-[1362px] lg:mb-[882px] 3xl:mt-[112px] lg:mt-[73px] xl:mt-[83px] 2xl:mt-[94px] px-[1px] w-[49%]">
                      <Column
                        className="common-pointer absolute h-[max-content] inset-[0] items-center justify-center m-[auto] w-[96%]"
                      ...
                      <Text className="absolute font-bold right-[36%] lg:text-[15px] xl:text-[17px] 2xl:text-[20px] 3xl:text-[24px] text-light_blue_500 top-[0] w-[auto]">
                        *
                      </Text>
                      <Stack className="absolute bg-gray_300 lg:h-[18px] xl:h-[21px] 2xl:h-[24px] 3xl:h-[28px] inset-y-[0] my-[auto] px-[1px] right-[0] w-[2%]">
                        <Img
                    ...
                    <Column className="items-center 3xl:mr-[10px] lg:mr-[7px] xl:mr-[8px] 2xl:mr-[9px] 3xl:mt-[118px] lg:mt-[77px] xl:mt-[88px] 2xl:mt-[99px] w-[47%]">
                      ...
                      <Column className="bg-gray_50 border border-gray_301 border-solid items-center mt-[3px] lg:p-[38px] xl:p-[44px] 2xl:p-[50px] 3xl:p-[60px] rounded-radius11 w-[100%]">
            ...
            <Column className="bg-white_A700 border border-gray_301 border-solid items-center xl:pb-[1115px] 2xl:pb-[1254px] 3xl:pb-[1505px] lg:pb-[975px] w-[19%]">
              <Column className="bg-white_A700 items-center w-[100%]">
                ...
                <Row className="bg-white_A700 border border-gray_301 border-solid items-center xl:p-[10px] 2xl:p-[12px] 3xl:p-[14px] lg:p-[9px] w-[100%]">
                  <Radio
                    value="Required"
                    className="font-normal ml-[4px] not-italic lg:pl-[3px] xl:pl-[4px] 2xl:pl-[5px] 3xl:pl-[6px] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900"
                  ...
                  <Switch
                    value={false}
                    className="mb-[1px] lg:ml-[10px] xl:ml-[11px] 2xl:ml-[13px] 3xl:ml-[15px] w-[15%]"
                  />
                </Row>
              </Column>
            </Column>
...
export default SheetsTwelvePage;
