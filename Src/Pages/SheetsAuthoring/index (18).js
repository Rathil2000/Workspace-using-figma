...
const SheetsauthoringPage = () => {
  const navigate = useNavigate();

  function handleNavigate28() {
    navigate("/sheets");
  }
  function handleBackNavigation17() {
    navigate(-1);
  }
          ...
          <Row className="items-center w-[100%]">
            <Stack className="bg-white_A700 border border-gray_301 border-solid lg:h-[39px] xl:h-[45px] 2xl:h-[51px] 3xl:h-[61px] lg:px-[11px] xl:px-[13px] 2xl:px-[15px] 3xl:px-[18px] rounded-radius11 w-[3%]">
              <Img
                ...
                onClick={handleBackNavigation17}
                alt="arrowleft"
              />
            </Stack>
            ...
            <Stack className="lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[81%]">
              <Stack className="absolute lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[100%]">
                <Row className="absolute items-center justify-evenly w-[100%]">
                  ...
                  <div className="bg-white_A700 border border-gray_301 border-solid lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[77%]"></div>
                </Row>
              ...
              <Column
                className="common-pointer absolute bg-light_blue_50_a5 border border-gray_301 border-solid lg:p-[6px] xl:p-[7px] 2xl:p-[8px] 3xl:p-[9px] right-[0] top-[0] w-[77%]"
...
export default SheetsauthoringPage;
