...
const SheetsPage = () => {
  ...
  function handleBackNavigation16() {
    navigate(-1);
  }
          ...
          <Row className="items-center w-[100%]">
            <Stack className="bg-white_A700 border border-gray_301 border-solid lg:h-[39px] xl:h-[45px] 2xl:h-[51px] 3xl:h-[61px] lg:px-[11px] xl:px-[13px] 2xl:px-[15px] 3xl:px-[18px] rounded-radius11 w-[3%]">
              <Img
                ...
                onClick={handleBackNavigation16}
                alt="arrowleft"
              />
            </Stack>
            ...
            <Stack className="lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[81%]">
              <Stack className="absolute lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[100%]">
                <Row className="absolute items-center justify-evenly w-[100%]">
                  ...
                  <Column className="bg-white_A700 border border-gray_301 border-solid items-center lg:p-[14px] xl:p-[16px] 2xl:p-[18px] 3xl:p-[21px] w-[77%]">
                    <Row className="items-center 3xl:mt-[106px] lg:mt-[69px] xl:mt-[79px] 2xl:mt-[89px] w-[45%]">
                      <Text
                        className="common-pointer font-normal not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-black_900 w-[auto]"
                      ...
                      <Img
                        ...
                        className="xl:h-[3px] lg:h-[3px] 3xl:h-[4px] 2xl:h-[4px] lg:ml-[216px] xl:ml-[247px] 2xl:ml-[278px] 3xl:ml-[333px] w-[5%]"
                        alt="Vector"
                      />
                    </Row>
                    <Stack className="xl:h-[112px] 2xl:h-[126px] 3xl:h-[151px] lg:h-[98px] xl:mb-[1008px] 2xl:mb-[1134px] 3xl:mb-[1361px] lg:mb-[882px] lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] w-[48%]">
                      <Column className="absolute bg-gray_50 border border-gray_301 border-solid 2xl:p-[11px] 3xl:p-[13px] lg:p-[8px] xl:p-[9px] right-[1%] rounded-radius11 w-[99%]">
                        <Row className="items-center mt-[1px] w-[98%]">
                          ...
                          <Input
                            className="font-normal not-italic p-[0] lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] placeholder:text-gray_600 text-gray_600 w-[100%]"
                      ...
                      <Stack className="absolute bg-gray_300 lg:h-[18px] xl:h-[21px] 2xl:h-[24px] 3xl:h-[28px] px-[1px] right-[0] top-[36%] w-[2%]">
                        <Img
