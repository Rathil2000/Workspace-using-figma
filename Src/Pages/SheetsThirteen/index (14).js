...
const SheetsThirteenPage = () => {
  const navigate = useNavigate();

  function handleNavigate7() {
    navigate("/sheetsfourteen");
  }
            ...
            <Stack className="lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[81%]">
              <Stack className="absolute lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[100%]">
                <Row className="absolute items-center justify-evenly w-[100%]">
                  ...
                  <Row className="bg-white_A700 border border-gray_301 border-solid justify-between lg:p-[13px] xl:p-[15px] 2xl:p-[17px] 3xl:p-[20px] w-[77%]">
                    <Stack className="lg:h-[114px] xl:h-[130px] 2xl:h-[147px] 3xl:h-[176px] xl:mb-[1009px] 2xl:mb-[1135px] 3xl:mb-[1362px] lg:mb-[882px] ml-[1px] 3xl:mt-[109px] lg:mt-[70px] xl:mt-[80px] 2xl:mt-[91px] w-[48%]">
                      <Column className="absolute items-center right-[1%] w-[99%]">
                      ...
                      <Stack className="absolute bg-gray_300 bottom-[39%] lg:h-[18px] xl:h-[21px] 2xl:h-[24px] 3xl:h-[28px] px-[1px] right-[0] w-[2%]">
                        <Img
                    ...
                    <Column
                      className="common-pointer xl:mb-[1010px] 2xl:mb-[1136px] 3xl:mb-[1363px] lg:mb-[883px] 3xl:mt-[106px] lg:mt-[69px] xl:mt-[79px] 2xl:mt-[89px] rounded-radius11 w-[48%]"
                    ...
                    >
                      ...
                      <Column className="bg-gray_50 border border-gray_301 border-solid items-center lg:mt-[5px] xl:mt-[6px] 2xl:mt-[7px] 3xl:mt-[8px] lg:p-[38px] xl:p-[44px] 2xl:p-[50px] 3xl:p-[60px] rounded-radius11 w-[100%]">
...
export default SheetsThirteenPage;
