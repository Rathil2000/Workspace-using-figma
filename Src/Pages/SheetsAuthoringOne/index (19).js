...
const SheetsauthoringOnePage = () => {
  const navigate = useNavigate();

  function handleBackNavigation7() {
    navigate(-1);
  }
          ...
          <Row className="items-center justify-evenly w-[100%]">
            <Stack className="lg:h-[1094px] xl:h-[1251px] 2xl:h-[1407px] 3xl:h-[1689px] w-[81%]">
              <Row className="absolute items-center justify-evenly w-[100%]">
                ...
                <Column className="bg-white_A700 border border-gray_301 border-solid items-center 3xl:p-[106px] lg:p-[69px] xl:p-[79px] 2xl:p-[89px] w-[77%]">
                  <Img
                    src="images/img_location.svg"
                    className="lg:h-[48px] xl:h-[55px] 2xl:h-[62px] 3xl:h-[74px] w-[9%]"
                    alt="location"
                  />
                  <Text className="font-normal xl:mb-[1008px] 2xl:mb-[1134px] 3xl:mb-[1361px] lg:mb-[882px] lg:mt-[11px] xl:mt-[13px] 2xl:mt-[15px] 3xl:mt-[18px] not-italic lg:text-[10px] xl:text-[12px] 2xl:text-[14px] 3xl:text-[16px] text-gray_600 w-[auto]">
...
export default SheetsauthoringOnePage;
